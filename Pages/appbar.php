<div class="appbar">
    <?php
        ...
        $id_appbar  = $res->fetch_array()["id_story"];
    ?>
    ...
    <div class="button" id="but4" onclick="location.href='../ProfilePage/storypage.php<?php echo '?id_story='.$id_appbar.'&type=rand' ?>';">Случайная работа</div>
    <?php
